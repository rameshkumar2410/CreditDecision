package com.db.creditdecision.constants;
...
public class ApplicationConstant {
	 ...
	 public static final String LOAN_SANCTIONED = "Loan already sanctioned, please apply after 30 days";
	 
	 public static final String SSN_NOT_FOUND = "SSN number not found";
